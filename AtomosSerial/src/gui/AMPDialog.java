package gui;
	 ...
	 *
	 */
	abstract public class AMPDialog extends JDialog {
		 ...
		 */
		public AMPDialog(Window parentFrame, String title, boolean hasDefault) {
			...
			setIconImage(new ImageIcon(ClassLoader
					.getSystemResource("resource/SettingsButtonSmall2.png")).getImage());
